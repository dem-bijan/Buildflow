...
export default function ThemeToggle({
    ...
    return (
        <div className="flex items-center gap-2.5">
            <span className={`text-[13px] transition-colors ${isDark ? "text-white font-medium" : "text-accent"}`}>
                Light
            </span>
        ...
        `}
          ...
          ${isDark
                        ? "translate-x-6 bg-accent border-accent"
        ...
        `}>
            ...
            <span className={`text-[13px] transition-colors ${isDark ? "text-accent-400 font-medium" : "text-content-muted"}`}>
                Dark
            </span>
        </div>
    );
